...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="news.php" class="h5 text-white">News</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="input-group">
        ...
        <button class="btn text-light px-4" style="background-color:#fb913c"><i class="bi bi-search"></i></button>
    </div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-12">
                <div class="row g-4">
                    ...
                    <!-- Repeat Blog Items -->
                    <div class="col-md-4 wow slideInUp" data-wow-delay="0.2s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                    ...
                    <!-- Repeat above blocks as needed for more posts -->
                ...
                <!-- <div class="col-lg-4">
                    ...
                    <!-- <div class="wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="bg-light text-center" style="padding: 30px;">
                            ...
                            <a href="" class="btn text-light py-2 px-4" style = "background-color:#fb913c">Read More</a>
                        </div>
                    </div> -->
                    <!-- Plain Text End -->
                </div>
